...
const showDeviceDetails = async (device: ExtendedDevice) => {
  ...
  await fetchDeviceChannels(device)
}

const fetchDeviceChannels = async (device: Device) => {
        ...
        <div class="device-info">
          ...
          <el-descriptions :column="2" border>
            ...
            <el-descriptions-item label="通道数量">
              <el-tag type="info">{{ currentDevice?.channelCount || 0 }}</el-tag>
            </el-descriptions-item>
          </el-descriptions>
        </div>
        ...
        <div class="channel-list">
          <div class="channel-header">
            ...
            <el-button
              ...
              @click="currentDevice && fetchDeviceChannels(currentDevice)"
            >
              <el-icon><Refresh /></el-icon>
              刷新通道
            </el-button>
